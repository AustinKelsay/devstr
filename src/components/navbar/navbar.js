    ...
    <div className={styles.navbar}>
      <Menu>
        ...
        <MenuList bg="#242424" borderColor="#8affd4">
          <MenuItem bg="#242424" color="#8affd4"><Link href="/">Home</Link></MenuItem>
          <MenuItem bg="#242424" color="#8affd4"><Link href="/profile">Profile</Link></MenuItem>
          <MenuItem bg="#242424" color="#8affd4"><Link href="/chat">Chat</Link></MenuItem>
        </MenuList>
      </Menu>
